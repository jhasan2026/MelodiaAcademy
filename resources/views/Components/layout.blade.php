...
{{--                                <a href="#" class="block px-4 py-2 text-xl text-gray-700 focus:bg-gray-100 focus:outline-hidden">Your profile</a>--}}
{{--                                <a href="#" class="block px-4 py-2 text-xl text-gray-700 focus:bg-gray-100 focus:outline-hidden">Settings</a>--}}
{{--                                <a href="#" class="block px-4 py-2 text-xl text-gray-700 focus:bg-gray-100 focus:outline-hidden">Sign out</a>--}}
{{--                            </el-menu>--}}
{{--                        </el-dropdown>--}}
{{--                    </div>--}}
{{--                </div>--}}
