                    ...
                    <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
                        <dl class="sm:divide-y sm:divide-gray-200">
                            <x-profile-details>
                                ...
                                <x-profile-details-info>{{ $user->first_name }}</x-profile-details-info>
                            </x-profile-details>
                            <x-profile-details>
                                <x-profile-details-label>Last Name</x-profile-details-label>
                                <x-profile-details-info>{{ $user->last_name }}</x-profile-details-info>
                            </x-profile-details>
                            <x-profile-details>
                                <x-profile-details-label>Email</x-profile-details-label>
                                <x-profile-details-info>{{ $user->email }}</x-profile-details-info>
                            </x-profile-details>
                            ...
                            @if($user->role === 'student')
                                ...
                                <x-profile-details>
                                    ...
                                    <x-profile-details-info>{{ $profile->gender }}</x-profile-details-info>
                                </x-profile-details>
                                <x-profile-details>
                                    <x-profile-details-label>Date of Birth</x-profile-details-label>
                                    <x-profile-details-info>{{ $profile->date_of_birth }}</x-profile-details-info>
                                </x-profile-details>

                            @elseif($user->role === 'instructor')
                                <x-profile-details>
                                    <x-profile-details-label>Bio</x-profile-details-label>
                                    <x-profile-details-info>{{ $profile->bio }}</x-profile-details-info>
                                </x-profile-details>
                                <x-profile-details>
                                    <x-profile-details-label>Specialization</x-profile-details-label>
                                    <x-profile-details-info>{{ $profile->specialization }}</x-profile-details-info>
                                </x-profile-details>
                                <x-profile-details>
                                    <x-profile-details-label>Experience Years</x-profile-details-label>
                                    <x-profile-details-info>{{ $profile->experience_years }}</x-profile-details-info>
                                </x-profile-details>
