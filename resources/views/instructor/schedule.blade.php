<x-layout>
    <x-slot:heading>Instructor Weekly Routine</x-slot:heading>
    ...
    <div class="space-y-4">
        ...
        <p class="text-sm text-gray-500">Click any class to see details.</p>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: {
                    url: "{{ route('instructor.schedule.events') }}", // ✅ different route
                    method: "GET",
